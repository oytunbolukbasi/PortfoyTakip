                      ...
                      >
                        <div className="p-4">
                          ...
                          <div className={`rounded-xl p-3 mb-4 ${
                            parseFloat(position.totalReturn) >= 0 
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <div className="flex items-center space-x-2">
                                <div className={`text-base font-bold ${
                                  parseFloat(position.totalReturn) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                                }`}>
                                  {parseFloat(position.totalReturn) >= 0 ? '+' : '-'}₺{formatTurkishPrice(Math.abs(parseFloat(position.totalReturn)))}
                                </div>
                                <div className={`text-sm font-medium ${
                                  parseFloat(position.returnPercent) >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                                }`}>
                                  ({parseFloat(position.returnPercent) >= 0 ? '+' : '-'}{Math.abs(parseFloat(position.returnPercent)).toFixed(2)}%)
                                </div>
                              </div>
                            </div>
                          </div>
